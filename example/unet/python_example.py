...
net.addNode("In", snOperator.Input(), "C1") \
   .addNode("C1", snOperator.Convolution(10, -1), "C2") \
   .addNode("C2",snOperator.Convolution(10, 0), "P1 Crop1") \
   ...
   \
   .addNode("C3", snOperator.Convolution(10, -1), "C4") \
   .addNode("C4", snOperator.Convolution(10, 0), "P2 Crop2") \
   ...
   \
   .addNode("C5", snOperator.Convolution(10, 0), "C6") \
   .addNode("C6", snOperator.Convolution(10, 0), "DC1") \
   ...
   \
   .addNode("C7", snOperator.Convolution(10, 0), "C8") \
   .addNode("C8", snOperator.Convolution(10, 0), "DC2") \
   ...
   \
   .addNode("C9", snOperator.Convolution(10, 0), "C10")

convOut = snOperator.Convolution(1, 0)
...
pathImg = 'c:/cpp/skyNet/example/unet/images/'
imgList = os.listdir(pathImg)

pathLabel= 'c:/cpp/skyNet/example/unet/labels/'
